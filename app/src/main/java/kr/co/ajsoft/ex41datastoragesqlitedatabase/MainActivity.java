package kr.co.ajsoft.ex41datastoragesqlitedatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //만들어진 DB파일에 member라는 이름으로 테이블 생성작업 수행.
    ...
    public void clickSelcetAll(View view) {

        Cursor cursor =db.rawQuery("SELECT * FROM "+tableName,null); //두번째 파라미터(null) : 검색조건
    ...
    public void clickSelcetByName(View view) {
    ...
    public void clickUpdate(View view) {
        String name=etName.getText().toString();
        db.execSQL("UPDATE "+tableName+" SET age=30,email='ss@sss.com' WHERE name=?",new String[]{name});
